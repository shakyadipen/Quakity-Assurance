...
public class Reporting extends TestListenerAdapter {    public ExtentHtmlReporter htmlReporter;
    public ExtentReports extent;
    public ExtentTest logger;
    public void onStart(ITestContext testContext) {
        String dateFormat = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new Date());
        String ReportName = "Guru-99-Banking" + dateFormat + ".html";
        ...
        htmlReporter.config().setDocumentTitle("INET BANKING");
